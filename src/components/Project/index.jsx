    ...
    <>
      <div className="rounded-lg bg-black h-full relative flex flex-col justify-between items-center">
        ...
        <div className="snap-x snap-mandatory overflow-hidden w-full mx-auto">
          ...
          <button className="absolute left-1 top-[35%] sm:top-[40%] bg-black hover:bg-purple-500 hover:shadow-purple-500/50 shadow-md shadow-black rounded-lg p-1 font-bold text-lg" onClick={handlePrev}>&larr;</button>
          <button className="absolute right-1 top-[35%] sm:top-[40%] bg-black hover:bg-purple-500 hover:shadow-purple-500/50 shadow-md shadow-black rounded-lg p-1" onClick={handleNext}>&rarr;</button>
        </div>
