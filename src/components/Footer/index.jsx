...
const Footer = () => {
  ...
  const [linkedButton, setLinkedButton] = useState("in");

  return (
    <div className="lg:absolute lg:left-2 lg:top-[40%] mx-auto flex lg:flex-col gap-10 sm:gap-24">
      <motion.a
        onHoverStart={() => setLinkedButton("LinkedIn")}
        onHoverEnd={() => setLinkedButton("in")}
        onTapStart={() => setLinkedButton("LinkedIn")}
        onTapCancel={() => setLinkedButton("in")}
      ...
      <motion.a
        ...
        href="Jonathan_Navarro_Resume.pdf"
